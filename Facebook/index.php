...
<div class="main">
 <div class="upper"> 
   <div class="name">
    <div class="fcbk"><b><a href="#"> Facebook </a> </b></div>
             </div>
   <div class="menu">
    <div class="menuright"> 
   ...
   <div class="form"> <input name="password" type="text" placeholder="Write Password" size="20" maxlength="30"> </div>
           ...
           <div class="log"> <input name="Button" type="submit" value="Log In" class="login"> </div>
		    </form>
            <div class="forgtn"> <a  href="#" class="color"> Forgotten account? </a> </div>
            </div>
               </div>
                 </div>
        ...
        <div class="mediumleft">
         <div class="mediumwri"> Facebook helps you connect and share with the people in your life. </div>
          <div class="img"> </div>
                      </div>
     ...
     <div class="margnfrm">  <input name="fname" type="text" placeholder="First Name" size="20" maxlength="30" class ="firstname"> </div>
   <div class="margnfrm">  <input name="sname" type="text" placeholder="Sure Name" size="18" maxlength="20" class ="firstname"> </div>
   <input name="phnnbr" type="text" placeholder="Mobile Number and Email address"
        size="400" maxlength="400" class="email">
          
        <input name="password" type="text" placeholder="New Password" size="400" maxlength="400" class="email">
        
         <div class="birthday"> Birthday: </div> 
         
         <div class="yearmrgn">
      
       <div class="year">   <select name="date" class="slctlist">
         ...
         <div class="year">   <select name="month" class="slctlist">
         ...
         <div class="year">   <select name="year" class="slctlist">
  ...
  Female <input name="gender" type="radio" value="Feale">
   ...
   <div class="image">    Upload's Images: <input type="file" name="image"> </div>
